...
const T = {
  en: {
    ...
    searching:"Searching…", notFound:"Parcel not found.", error:"Something went wrong.", found:"Parcel found", govGeDown:"maps.gov.ge unavailable — try again later...",
    ...
    pw:{
      ...
      r7:"Urban functional diversity",f7:"—",p7:"✓",
      r8:"Climate analysis <br><small style='opacity:.45;font-size:.9em'>Georgia partial, Tbilisi fully</small>",f8:"—",p8:"✓",
      r9:"Energy efficiency<br><small style='opacity:.45;font-size:.9em'>Georgia partial, Tbilisi fully</small>",f9:"—",p9:"✓",
      ...
      trialSub:"Your trial ends in X days. Subscribe now to keep extensive spatial analysis, report and data export features.",
  ...
  ka: {
    brand:"Urbanyx", placeholder:"01.15.07.002.057", btn:"ძიება", btnLoading:"...",
    searching:"ძებნა…", notFound:"ნაკვეთი ვერ მოიძებნა.", error:"შეცდომა.", found:"ნაკვეთი მოიძებნა", govGeDown:"maps.gov.ge მიუწვდომელია — სცადეთ მოგვიანებით...",
    ...
    analyseBtn:"საფეხმავლო ანალიზი", freeBadge:"უფასო", proAnalyseBtn:"სივრცითი ანალიზი",
    analysingIso:"1/2 · იზოქრონის განსაზღვრა…", analysingOsm:"2/2 · ობიექტების ძებნა...",
    analysingProIso:"1/2 · იზოქრონის განსაზღვრა…", analysingProLayers:"2/2 · განათლება და მობილობის მონაცემები…",
    climateBtn:"კლიმატის ანალიზი", climateCardTitle:"კლიმატის ანალიზი",
    retrying:"ხელახლა ცდა…", analysisError:"ანალიზი შეუძლებელია.",
    isoTitle:"ფეხით სავალი 10-წუთიანი ზონა", isoDesc:"საფეხმავლო ანალიზი - უფასო",
    isoTitlePro:"ფეხით სავალი 15-წუთიანი ზონა", isoDescPro:"საფეხმავლო ანალიზი - ფასიანი",
    scoreTitle:"მრავალფეროვნების ინდექსი", outOf:"შენონის ინდექსი",
    done:"ანალიზი განხორციელდა", proDone:"ანალიზი განხორციელდა - ფასიანი",
    mapillaryTitle:"ქუჩის სურათები", mapillaryNone:"სურათები ვერ მოიძებნა.",
    analyzing:"მიმდინარეობს ანალიზი…",
    mapillaryNear:"ქუჩის სურათები — ნაკვეთიდან 20მ-ში", mapillaryFar:"ქუჩის სურათები — უახლოეს სამეზობლოში",
    mapillaryOpen:"სურათზე დაჭერით გაიხსნება Mapillary",
    proLayersTitle:"სივრცითი ანალიზი",
    verdicts:["ძალიან ცუდი","ცუდი","საშუალო","კარგი","ძალიან კარგი","შესანიშნავი"],
    planFree:"უფასო სერვისი", planPro:"ფასიანი სერვისი",
    upgrade:"განახლება", billing:"ბილინგი", signOut:"გასვლა",
    centerSignIn:"შესვლა", centerSignUp:"ანგარიშის შექმნა", orClick:"დააკლიკეთ ან მოხაზეთ რუკაზე",
    cats:{ food:{label:"საკვები ობიექტები",icon:"🍽"}, health:{label:"ჯანდაცვა",icon:"🏥"}, parks:{label:"პარკები",icon:"🌿"}, retail:{label:"სავაჭრო",icon:"🛒"}, culture:{label:"კულტურა",icon:"🎭"} },
    ...
    accessibilityTitle:"მისაწვდომობის ანალიზი", accModeLabel:"სატრანსპორტო საშუალება", accTimeLabel:"გადაადგილების დრო", accGenerate:"იზოქრონის შექმნა", accModes:{walking:"ფეხით",cycling:"ველოსიპედით",driving:"ავტომობილით"}, accNoIso:"ჯერ შექმენით იზოქრონი", ttcAreaSmall:"არეალი 5,000 კვ.მ-ზე ნაკლებია — ჯერ შექმენით იზოქრონი", ttcAoiLabel:"საკვლევი არეალი", ttcTitle:"ტრანსპორტი", ttcNearby:"საზოგადოებრივი ტრანსპორტი", ttcNoStops:"მოცემულ იზოქრონში გაჩერება არ გვხვდება", ttcNoArrivals:"არ არის დაგეგმილი მგზავრობები", ttcOnTime:"გრაფიკის მიხედვით", ttcLoading:"იტვირთება...",
    reliefTypes:{ height:"სიმაღლე", slope:"დახრა", aspect:"სივრცითი ორიენტაცია" },
    reliefLoading:"იტვირთება რელიეფის ციფრული მოდელი…", reliefMin:"მინ", reliefMax:"მაქს", reliefMean:"საშ",
    reliefUnits:{ height:"მ ზ.დ.", slope:"°", aspect:"°" },
    slopeClasses:[{l:"სწორი",r:"<3°"},{l:"ოდნავ დახრილი",r:"3–8°"},{l:"საშუალოდ დახრილი",r:"8–15°"},{l:"ციცაბო",r:"15–30°"},{l:"ძალიან ციცაბო",r:">30°"}],
    slopeClassColors:["#34d399","#86efac","#fbbf24","#f97316","#ef4444"],
    solarSuitability:"მზის ენერგიის პოტენციალი", solarDesc:"სამხ. (135–225°), დახ. ≤ 30°",
    windBtn:"ქარის ანალიზი", windCardTitle:"ქარის ანალიზი",
    windSpeed:"ქარის საშ. სიჩქარე", windPowerDensity:"სიმძლავრის სიმჭიდროვე", windCapFactor:"სიმძლავრის კოეფ.",
    windYield:"სავარ. წლ. გამომუშავება", windRefTurbine:"5 კვტ ეტ. ტურბინა · 30მ სიმაღლე",
    windChecking:"გარემოს შემოწმება…", windBuildings:"500 მ. რადიუსში შენობები გვხვდება — ქარის ტურბინა ამ არეალში ვერ დაიდგმება",
    ...
    auth:{
      ...
      suTitle:"ანგარიშის შექმნა", suSub:"მოიცავს ფასიანი ვერსიის 14-დღიან საცდელ პერიოდს — ბარათი არ არის საჭირო",
      suName:"სრული სახელი",
      suSector:"სექტორი", suSectorPh:"აირჩიე",
      suSectors:["არქიტექტურა / ურბანული დიზაინი","ინჟინერია","უძრავი ქონება / დეველოპმენტი","სამთავრობო ორგანიზაცია / საჯარო სექტორი","აკადემია / კვლევა","ურბანული დაგეგმარება","მშენებლობა","ფინანსები / ინვესტიცია","იურიდიული","სხვა"],
      suOrg:"ორგანიზაცია (არასავალდებულო)",
      suRole:"როლი / პოზიცია",
      suPurpose:"გამოყენების მიზანი", suPurposePh:"აირჩიე",
      suPurposes:["გეოგრაფიული ანალიზი","ურბანული დაგეგმარება და კვლევა","ინვესტიცია / ყოვლისმომცველი ანალიზი","აკადემიური კვლევა","პროფესიული მომსახურება","პირადი ინტერესი","სხვა"],
      ...
      errFill:"გთხოვთ, შეავსე ყველა ველი.",
    ...
    pw:{
      title:"ფასიან ვერსიაზე გადასვლა",sub:"შექმენი უფასო ანგარიში და მიიღე ანალიზის 50 ტოკენი. ფასიანი ვერსია გაძლევს ანალიზის 1000 ტოკენს და სხვა პრემიუმ ფუნქციებს.",
      ...
      r2:"ზონირების ანალიზი<br><small style='opacity:.45;font-size:.9em'>მხოლოდ თბილისი</small>",f2:"50",p2:"1000",
      r3:"შექმენი სივრცითი გეგმა",f3:"—",p3:"✓",
      r4:"ქუჩის სურათები",f4:"✓",p4:"✓",
      r5:"ურბანული მობილობა<br><small style='opacity:.45;font-size:.9em'>მხოლოდ თბილისი</small>",f5:"—",p5:"✓",
      r6:"სივრცითი სინტაქსი",f6:"✓",p6:"✓",
      r7:"ურბანული ფუნქციური მრავალფეროვნება",f7:"✓",p7:"✓",
      r8:"კლიმატის ანალიზი<br><small style='opacity:.45;font-size:.9em'>საქართველო ნაწილობრივ, თბილისი სრულად</small>",f8:"—",p8:"✓",
      r9:"ენერგოეფექტურობა<br><small style='opacity:.45;font-size:.9em'>საქართველო ნაწილობრივ, თბილისი სრულად</small>",f9:"—",p9:"✓",
      r10:"რელიეფის ანალიზი<br><small style='opacity:.45;font-size:.9em'>მხოლოდ თბილისი</small>",f10:"—",p10:"✓",
      cta:"ფასიანზე გადასვლა",notSignedIn:"ანგარიში არ გაქვს?",createFirst:"შექმენი უფასო ანგარიში",
      trialNote:"მოიცავს ფასიანი ვერსიის 14-დღიან საცდელ პერიოდს",
      trialTitle:"წვდომის შესანარჩუნებლად განაახლე ფასიანი ვერსია",
      trialSub:"საცდელი პერიოდი სრულდება X დღეში. გამოიწერე ახლა სრულყოფილი სივრცითი ანალიზის, .",
