...
const SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inlpa2tsaWdzYnB6aHpuaGtpYm93Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzY1MDQxNDQsImV4cCI6MjA5MjA4MDE0NH0.bB5vCE5sv5GX4DfhkZ0f7r1V5VZiM4Y6evOK8kVGmtk";
...
function applyLang(){
  ...
  document.getElementById("export-btn-label").textContent=tr.exportBtn;
...
function _activateBld(id){
  ...
  document.getElementById('poly-dl-btn').disabled=false;
  _update3DMetrics();
...
function openBillingPortal(){
  ...
  document.getElementById('bill-lbl-pm').textContent=bd.billingLblPm;
  const pmEl=document.getElementById('bill-pm-content');
  pmEl.innerHTML=isPro
    ?`<div class="billing-empty" style="color:rgba(255,255,255,0.35)">Managed by Paddle</div>`
    :`<div class="billing-empty">${bd.billingNoCard}</div>`;
...
async function runAnalysis(){
  ...
  try{
    ...
    if(currentUser?.plan==="pro"){document.getElementById("export-btn").style.display="flex";}
  }catch(e){
...
async function runProAnalysis(){
  ...
  try{
    ...
    document.getElementById("geodata-btn").style.display="flex";
    document.getElementById("geodata-btn-label").textContent=t().geodataBtn;
  }catch(e){
