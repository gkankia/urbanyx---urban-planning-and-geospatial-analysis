...
/* ── cover ───────────────────────────────────────────────── */
.cv{display:flex;flex-direction:column;height:259mm}
.cv .mk{display:flex;align-items:center;gap:11px}
.cv .mk img{height:34px}
.cv .mk .wm{font-size:23px;font-weight:600;letter-spacing:0.15em;
  text-transform:uppercase;color:var(--ink);line-height:1}
.cv .top-rule{height:1px;background:var(--rule);margin:26px 0 44px}
.cv h1{font-size:46px;font-weight:600;color:var(--ink);letter-spacing:-0.022em;
  line-height:1.06;margin-top:9px}
.cv .place{font-size:21px;color:var(--mute);margin-top:9px;letter-spacing:-0.005em}
.cv .meta{display:grid;gap:16px;margin-top:40px;padding-top:19px;
  border-top:1px solid var(--rule)}
.cv .meta .k{font-size:10px;font-weight:600;letter-spacing:0.11em;
  text-transform:uppercase;color:var(--faint)}
.cv .meta .v{font-size:14px;color:var(--ink);margin-top:4px}
.cv .foot{margin-top:auto;flex:none;display:grid;grid-template-columns:1fr 1fr;gap:26px;
  padding-top:20px;border-top:1px solid var(--rule);align-items:end}
.cv .foot .k{font-size:10px;font-weight:600;letter-spacing:0.11em;
  text-transform:uppercase;color:var(--faint)}
.cv .foot .v{font-size:14px;color:var(--ink);margin-top:5px}
.cv .foot .v.ph{color:var(--faint)}
.cv .zx{font-size:11px;color:var(--faint);text-align:right}
`;
